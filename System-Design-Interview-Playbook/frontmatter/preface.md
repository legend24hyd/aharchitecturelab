...
The manuscript is Markdown in Git so chapters, Mermaid, and Draw.io files can be revised like code. Version 1.0 is the first complete edition of the method plus a small set of interview problems. Later editions can add problems without changing Part I.
