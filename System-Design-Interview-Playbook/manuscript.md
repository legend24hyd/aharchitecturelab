...
1. [Title page](frontmatter/title-page.md)
2. [Copyright](frontmatter/copyright.md)
3. [Dedication](frontmatter/dedication.md)
4. [Foreword](frontmatter/foreword.md)
5. [Preface](frontmatter/preface.md)
6. [Acknowledgements](frontmatter/acknowledgements.md)
...
- [Appendix A — Board cheat sheet](appendix/appendix-a-cheat-sheet.md)
- [References](references/references.md)

## Diagrams

Each chapter owns `diagrams/chapterNN/`. Mermaid may also live inline in the Markdown.
